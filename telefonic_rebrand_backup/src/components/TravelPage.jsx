    ...
    return (
        <section className="min-h-screen w-full bg-[#0c0c0c] pt-32 pb-20 px-4 md:px-10">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <h1 className="font-serif text-5xl md:text-7xl text-white mb-6">Explore <span className="text-brand-gold">Collection</span></h1>
                    <p className="text-white/60 font-sans text-lg max-w-2xl mx-auto">
                        Explore our curated selection of premium technology. <br />
                        <span className="text-brand-gold font-bold text-sm uppercase tracking-widest mt-2 inline-block">Double Click to Buy</span>
                    </p>
                </motion.div>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-8 flex flex-col justify-end">
                                ...
                                <div className="h-0 overflow-hidden group-hover:h-auto transition-all duration-500">
                                    ...
                                    <p className="text-brand-gold font-mono text-lg">{dest.price} <span className="text-xs text-white/40 align-middle">/ Device</span></p>
                                </div>
                            </div>
