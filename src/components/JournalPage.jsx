            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-24 py-10 border-b border-white/10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                        ...
                        <p className="font-mono text-xs text-travel-white uppercase tracking-widest">
                            READ TIME: VARIES
                        </p>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="md:col-span-7 flex flex-col h-full justify-between">
                                <div>
                                    ...
                                    <h2 className="font-serif text-3xl md:text-5xl leading-tight mb-6 group-hover:text-travel-white transition-colors duration-300">
                                        {post.title}
                                    </h2>
                                ...
                                <div className="flex items-center gap-2 text-sm uppercase tracking-widest font-bold group-hover:gap-4 transition-all duration-300">
                                    Read Article <span className="text-travel-white">→</span>
                                </div>
                            </div>
                        </motion.article>
                    ))}
